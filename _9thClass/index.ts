...
// }
// console.log(UserObj);
// console.log(UserObj.name , UserObj.Designation , UserObj.Residence); // Key ky baad jo Dot aata hy usy Dot Notation kehty hen
// console.log(UserObj["name"],UserObj["Designation"],UserObj["Residence"]); // Key ky baad jo square bracket aaty hen unhen Square Notation kehty hen
...
//         age: 22,
//         city: "Karachi"
//         Qualities:                   // This is Nested means a Box inside an another Box
//          {
//              HairColour : "Black",
//              SkinTone : "White",
//              Body : "Muscular"
...
//     }
// ]
// console.log(Nested.Qualities.Body);
// console.log(Nested["Qualities"]["Body"]);
// console.log(Nested.Qualities["Body"]);
// console.log(Nested[0],Qualities["Body"]);            //[0] Means Ilyas object [1] means Rafay object]